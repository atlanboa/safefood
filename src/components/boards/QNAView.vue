    ...
    <div class="container">
        ...
        <table class="table table-hover">
            <tr class="table-active">
                <td colspan="2"><h1 v-html="qna.title"></h1></td>
            </tr>
            <tr>
                <td>작성자</td>
        ...
        <table class="table table-hover">
            <tr v-for="(ans, index) in answers" :key="index">
                ...
                <td>
                    <input class="btn btn-outline-dark" type="button" value="삭제" @click="delComment(ans.cno)">
                </td>
            </tr>
        </table>
        <form @submit="addComment">
            <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="답변 추가....." aria-label="Recipient's username" aria-describedby="basic-addon2" v-model="comment">
